...
def add_model_args(parser):
    ...
    model.add_argument('--d_k', type=int, default=64, #64
                       help='Hidden size of heads in multi-head attention')
    model.add_argument('--d_v', type=int, default=64,
                       help='Hidden size of heads in multi-head attention')
    model.add_argument('--num_head', type=int, default=16,
    ...
    model.add_argument('--max_level', type=int, default=90,
                       help='Use layer-wise attention in Transformer')

    #GGNN specific params
    model.add_argument('--state_dim', type=int, default=512)
    model.add_argument('--annotation_dim', type=int, default=350)
    model.add_argument('--n_edge_types', type=int, default=4)
    model.add_argument('--n_node', type=int, default=200)
    model.add_argument('--n_steps', type=int, default=5)
    model.add_argument('--output_type', type=str, default='no_reduce')
    model.add_argument('--n_layers', type=int, default=2)
    model.add_argument('--n_hidden', type=int, default=512)
    model.add_argument('--graph_attn_mode', type=str, default='sigmoid_scalar')
    model.add_argument('--word_split', type='bool', default=True,)
    model.add_argument('--pooling_type', type=str, default='max_pooling',)
    model.add_argument('--max_word_num', type=int, default='30',)
    ...
    optim.add_argument('--learning_rate', type=float, default=0.00005,
    ...
    optim.add_argument('--warmup_steps', type=int, default=1000,
