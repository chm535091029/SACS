...
class Code2NaturalLanguage(object):
    ...
    def update(self, ex):
        ...
        # batched_g = ex['batched_g']
        code_level_rep = ex['code_level_rep']
        src_code_rep = ex['src_code_rep']
        src_code_len_rep = ex['src_code_len_rep']
        map = ex['map']
        node_rep = ex['node_rep']
        edge_rep = ex['edge_rep']
        node_batch_rep = ex['node_batch_rep']
        node_level_rep = ex['node_level_rep']
        ...
        tgt_seq = ex['tgt_seq']
        init_summ_len_rep = ex['init_summ_len_rep']
        init_summ_rep = ex['init_summ_rep']
